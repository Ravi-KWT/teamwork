...
<div ng-controller="ResourceCtrl" >
	...
	<ul class="nav nav-tabs clearfix">
        ...
        <li class="active"><a href="{!! route('projects-list',['archive'])!!}">Archived Projects</a></li>
						...
						<tbody>
							@forelse($projects as $project)
								<tr>
									...
									<td>{!! Former::select("status",'')->options([""=>'Change Status','active'=>'Active','onhold'=>'On Hold','completed'=>'Completed'])->id($project->id)->class('change-project-status form-control')!!}</td>
								</tr>
							@empty
